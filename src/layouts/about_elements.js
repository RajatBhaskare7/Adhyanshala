                    ...
                    <div className="row justify-content-center">
                        ...
                        <div className="col-md-6 col-lg-3 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="300">
                            <div className="icon-box">
                                ...
                                <p className="description">Talent is universal, but opportunities are not. With access to online
                                    learning resources and instruction, anyone, anywhere, can.
                                </p>
                            </div>
                        </div>
    ...
    <img src={wave3} width="100%" className="mt-5"/>
      ...
      <img src={wave4} width="100%" className="mb-5"/>
            <section className="home-clients">
                <div className="container">
                    <div className="main-text section-title mt-5 mb-3 text-center" data-aos="fade-up" data-aos-delay="0.1s">
                        <h2 className="text-black">Features</h2>
                        <p className="mt-4">
                            Our Artificial Intelligence powered tools use millions of project data
                        </p>
                    </div>
